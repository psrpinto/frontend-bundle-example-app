...
var config = {
  ...
  sources: {
    images: 'images/**/*',
    stylesheets: ['stylesheets/**/*.scss', '!stylesheets/_*', '!stylesheets/vendor.scss'],
    scripts: 'scripts/**/*.js'
  },
  ...
  // Vendor paths
  vendor: {
    stylesheet: path.join('stylesheets', 'vendor.scss'),
